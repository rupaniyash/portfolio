...
const Portfolio = () => {
  ...
  const MobileNavLink = ({ id, label }) => (
    <button
      onClick={() => scrollToSection(id)}
      className="block w-full text-left py-3 px-4 text-slate-300 hover:bg-slate-800 hover:text-cyan-400 border-l-2 border-transparent hover:border-cyan-400 transition-all"
    >
      {label}
    </button>
  );
    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-cyan-500/30">
      ...
      >
        <div className="max-w-6xl mx-auto px-6 flex justify-between items-center">
          <div className="text-2xl font-bold tracking-tighter text-cyan-400 flex items-center gap-2">
            <Terminal size={24} />
          ...
          <div className="hidden md:flex gap-8 items-center">
            ...
            <button 
              ...
              className="px-5 py-2 rounded-full border border-cyan-500 text-cyan-400 hover:bg-cyan-500/10 transition-all text-sm font-medium"
            >
              Let's Talk
            </button>
          </div>
      ...
      <section id="home" className="min-h-screen flex items-center justify-center pt-20 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-block px-3 py-1 rounded-full bg-cyan-950/50 border border-cyan-900 text-cyan-400 text-sm font-mono mb-2">
              Hello, World! I am
            </div>
            ...
            <div className="flex gap-4 pt-4">
              <a href="https://github.com/rupaniyash" target="_blank" rel="noreferrer" className="p-3 rounded-lg bg-slate-800 hover:bg-slate-700 hover:text-cyan-400 transition-all">
                <Github size={20} />
              </a>
              <a href="https://www.linkedin.com/in/yash-rupani-/" target="_blank" rel="noreferrer" className="p-3 rounded-lg bg-slate-800 hover:bg-slate-700 hover:text-blue-400 transition-all">
                <Linkedin size={20} />
              </a>
              <a href="mailto:rupaniyash1818@gmail.com" className="p-3 rounded-lg bg-slate-800 hover:bg-slate-700 hover:text-red-400 transition-all">
                <Mail size={20} />
              </a>
            </div>
          </div>
          ...
          <div className="relative hidden md:block group">
            ...
            <div className="relative bg-slate-900 rounded-2xl p-6 border border-slate-800 font-mono text-sm shadow-2xl">
            ...
            <div className="space-y-4">
               ...
               <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl hover:border-cyan-500/30 transition-colors">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      <h4 className="text-lg font-medium text-slate-200">Master of Engineering in Computer Science</h4>
                      <p className="text-cyan-400 text-sm">Oregon State University</p>
                    </div>
                    <span className="text-xs font-mono bg-slate-800 px-2 py-1 rounded text-slate-400">2023 - 2025</span>
                  </div>
               </div>
               ...
               <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl hover:border-cyan-500/30 transition-colors">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      <h4 className="text-lg font-medium text-slate-200">Bachelor of Technology in Electrical Engineering</h4>
                      <p className="text-cyan-400 text-sm">Pandit Deendayal Energy University</p>
                    </div>
                    <span className="text-xs font-mono bg-slate-800 px-2 py-1 rounded text-slate-400">2017 - 2021</span>
                  </div>
               </div>
            </div>
          </div>
          ...
          <div className="space-y-12 relative border-l-2 border-slate-800 ml-3 md:ml-6">
            ...
            {[
              ...
              <div key={index} className="relative pl-8 md:pl-12 group">
                ...
                <div className="flex flex-wrap gap-2 items-center text-sm text-slate-400 mt-1 mb-3">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-slate-900 rounded-xl p-8 border border-slate-800 hover:border-red-500/50 hover:shadow-lg hover:shadow-red-500/10 transition-all group">
              ...
              <h3 className="text-xl font-bold text-slate-200 mb-3 group-hover:text-red-400 transition-colors">YouTube Data Engineering</h3>
              ...
              <div className="flex flex-wrap gap-2">
                {["AWS S3", "AWS Glue", "AWS Athena", "Python", "QuickSight"].map(tag => (
                  <span key={tag} className="text-xs font-mono text-red-300/80 bg-red-950/30 px-2 py-1 rounded">
                    {tag}
                  </span>
                ))}
              </div>
            ...
            <div className="bg-slate-900 rounded-xl p-8 border border-slate-800 hover:border-green-500/50 hover:shadow-lg hover:shadow-green-500/10 transition-all group">
              ...
              <h3 className="text-xl font-bold text-slate-200 mb-3 group-hover:text-green-400 transition-colors">Financial News Sentiment Analysis</h3>
              <p className="text-slate-400 text-sm mb-6 leading-relaxed">
              ...
              <div className="flex flex-wrap gap-2">
                {["Python", "NLP", "Scikit-learn", "Pandas", "Sentiment Analysis"].map(tag => (
                  <span key={tag} className="text-xs font-mono text-green-300/80 bg-green-950/30 px-2 py-1 rounded">
                    {tag}
                  </span>
                ))}
              </div>
      ...
      <section id="skills" className="py-24 bg-slate-900/50">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-100 mb-4">Technical Arsenal</h2>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-2">
                {["Python", "SQL", "Flask", "Shell Scripting"].map(skill => (
                  <div key={skill} className="bg-slate-900 border border-slate-800 p-3 rounded text-sm text-slate-300 hover:border-cyan-500/30 transition-colors">
                    {skill}
                  </div>
                ))}
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-2">
                {["Apache Spark", "PySpark", "Kafka", "Airflow", "Hadoop", "Snowflake"].map(skill => (
                  <div key={skill} className="bg-slate-900 border border-slate-800 p-3 rounded text-sm text-slate-300 hover:border-blue-500/30 transition-colors">
                    {skill}
                  </div>
                ))}
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-purple-400 mb-2">
                <Cloud size={20} />
                <h3 className="font-semibold">Cloud & DB</h3>
              </div>
              <div className="flex flex-col gap-2">
                {["AWS (S3, EMR, Lambda)", "GCP (BigQuery)", "PostgreSQL", "MongoDB", "Firestore"].map(skill => (
                  <div key={skill} className="bg-slate-900 border border-slate-800 p-3 rounded text-sm text-slate-300 hover:border-purple-500/30 transition-colors">
                    {skill}
                  </div>
                ))}
              </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-green-400 mb-2">
                <Terminal size={20} />
                <h3 className="font-semibold">DevOps & ML</h3>
              </div>
              <div className="flex flex-col gap-2">
                {["Docker", "Git/GitHub", "Pandas & NumPy", "RAG / FAISS", "Tableau"].map(skill => (
                  <div key={skill} className="bg-slate-900 border border-slate-800 p-3 rounded text-sm text-slate-300 hover:border-green-500/30 transition-colors">
                    {skill}
                  </div>
                ))}
              </div>
      ...
      <section id="contact" className="py-24 text-center">
        <div className="max-w-2xl mx-auto px-6">
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-cyan-600 hover:bg-cyan-500 text-white rounded-full font-semibold transition-all shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 hover:-translate-y-1"
          >
            <Mail size={20} />
            Say Hello
          </a>
